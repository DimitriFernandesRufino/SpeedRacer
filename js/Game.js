class Game {
  ...
  start() {
    ...
    // Adicione o sprite de combustível ao jog
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          this.handleObstacleColission(index);
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 130, height - player.positionY - 275, 20, 20);
    fill("white");
    rect(width / 2 - 100, height - player.positionY - 275, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 100, height - player.positionY - 275, player.fuel, 20);
    noStroke();
    pop();
  }
...
showRank() {
  ...
  gameOver() {
    ...
    swal({
      title: `Fim de Jogo`,
      text: "Ops, seu carro explodiu....!!!",
      imageUrl:
      "https://imagensemoldes.com.br/wp-content/uploads/2018/06/Emoji-Triste-PNG.png",
      imageSize: "100x100",
      confirmButtonText: "Obrigado por Jogar"
    });
  }
